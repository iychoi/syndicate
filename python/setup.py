...
setup(name='syndicate',
      ...
      packages = ['syndicate',
                  ...
                  'syndicate.ag.fs_driver_common.fs_backends.irods',
                  'syndicate.ag.fs_driver_common.fs_backends.local_filesystem',
                  'syndicate.rg',
      ...
      package_dir = {
                  ...
                  'syndicate.ag.fs_driver_common.fs_backends.irods': os.path.join(ext_source_root, build_dir, 'syndicate/ag/fs_driver_common/fs_backends/irods'),
                  'syndicate.ag.fs_driver_common.fs_backends.local_filesystem': os.path.join(ext_source_root, build_dir, 'syndicate/ag/fs_driver_common/fs_backends/local_filesystem')
      },
